...
* Be default, `UNIQUE` and `PRIMARY KEY` constraint checks are deffered until statement commit. This behavior can be changed with XYZ setting. 
...
* ROLLBACK
* BEGIN
* Defering constraint checks setting.
