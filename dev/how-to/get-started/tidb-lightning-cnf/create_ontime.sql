...
DROP TABLE IF EXISTS `ontime`.`ontime`;
CREATE TABLE `ontime`.`ontime` (
  ...
  `Reporting_Airline` char(7) DEFAULT NULL,
  `DOT_ID_Reporting_Airline` int(11) DEFAULT NULL,
  `IATA_CODE_Reporting_Airline` char(2) DEFAULT NULL,
  `Tail_Number` varchar(50) DEFAULT NULL,
  `Flight_Number_Reporting_Airline` varchar(10) DEFAULT NULL,
  ...
  `DepDelay` decimal(10,2) DEFAULT NULL,
  `DepDelayMinutes` decimal(10,2) DEFAULT NULL,
  `DepDel15` decimal(10,2) DEFAULT NULL,
  `DepartureDelayGroups` int(11) DEFAULT NULL,
  `DepTimeBlk` varchar(20) DEFAULT NULL,
  `TaxiOut` decimal(10,2) DEFAULT NULL,
  `WheelsOff` char(4) DEFAULT NULL,
  `WheelsOn` char(4) DEFAULT NULL,
  `TaxiIn` decimal(10,2) DEFAULT NULL,
  `CRSArrTime` varchar(4) DEFAULT NULL,
  `ArrTime` int(11) DEFAULT NULL,
  `ArrDelay` decimal(10,2) DEFAULT NULL,
  `ArrDelayMinutes` decimal(10,2) DEFAULT NULL,
  `ArrDel15` decimal(10,2) DEFAULT NULL,
  `ArrivalDelayGroups` int(11) DEFAULT NULL,
  `ArrTimeBlk` varchar(20) DEFAULT NULL,
  `Cancelled` decimal(3,2) DEFAULT NULL,
  `CancellationCode` char(1) DEFAULT NULL,
  `Diverted` decimal(10,2) DEFAULT NULL,
  `CRSElapsedTime` decimal(10,2) DEFAULT NULL,
  `ActualElapsedTime` decimal(10,2) DEFAULT NULL,
  `AirTime` decimal(10,2) DEFAULT NULL,
